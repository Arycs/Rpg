...
public class SaveManager : MonoBehaviour
{
    ...
    public void ShowDialogue(GameObject clickButton)
    {
        ...
        {
            case "Load":
                dialogueText.text = "加载游戏？";
                break;
            case "Save":
                dialogueText.text = "存储游戏？";
                break;
            case "Delete":
    ...
    {
        data.MyPlayerData = new PlayerData(Player.MyInstance.MyLevel,Player.MyInstance.MyXp.MyCurrentValue,Player.MyInstance.MyXp.MyMaxValue,Player.MyInstance.MyHealth.MyCurrentValue,Player.MyInstance.MyHealth.MyMaxValue,Player.MyInstance.MyMana.MyCurrentValue,Player.MyInstance.MyMana.MyMaxValue,Player.MyInstance.transform.position);
    }
